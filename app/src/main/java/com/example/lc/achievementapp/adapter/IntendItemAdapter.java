...
public class IntendItemAdapter extends RecyclerView.Adapter {
    ...
    public IntendItemAdapter(Context context, List<Achievement> achievementList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new IntendItemViewHolder(LayoutInflater.from(context).inflate(R.layout.item_intend_rv, viewGroup, false));
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        ...
        IntendItemViewHolder holder = (IntendItemViewHolder) viewHolder;
            ...
            public void onClick(View v) {
                if(onItemDeleteClickListener != null){
                    ...
                    animatorX.addListener(new Animator.AnimatorListener() {
                        ...
                        @Override
                        public void onAnimationEnd(Animator animation) {
                            onItemDeleteClickListener.onItemAbandonClick(i);
                        }
    ...
    public class IntendItemViewHolder extends RecyclerView.ViewHolder{

        @BindView(R.id.sml_item_intend)
        SwipeMenuLayout swipe;
        @BindView(R.id.rl_item_intend)
        RelativeLayout item;
        @BindView(R.id.cb_item_intend_selected)
        CheckBox cbSelected;
        @BindView(R.id.tv_item_intend_title)
        TextView tvTitle;
        @BindView(R.id.tv_item_intend_start_date)
        TextView tvStartDate;
        @BindView(R.id.tv_item_intend_delete)
        TextView tvAbandon;

        public IntendItemViewHolder(@NonNull View itemView) {
            super(itemView);
    ...
    public void setOnItemAbandonClickListener(OnItemDeleteClickListener onItemDeleteClickListener) {
